...
const allReviews: Review[] = [
  ...
  { id: "r11", name: "Chris B.", location: "Nashville, TN", rating: 5, date: "2026-01-30", title: "From skeptic to believer", comment: "I thought this was too good to be true. But the $500 refundable deposit and $150/mo plan removed all risk. Now I'm earning passive income while working my day job. Life changing.", verified: true, helpful: 38 },
