...
const testimonials = [
  ...
  { name: "Sarah K.", location: "Dallas, TX", machine: "MarketOne 5W", income: "$900/mo", rating: 5, quote: "The $150/month plan made it risk-free for me. No giant upfront check, just a manageable subscription. Best investment I've made.", avatar: "SK" },
